...
export default function YourLabel({ yourSide }: { yourSide: 'W' | 'B' }) {
  ...
  return (
    <div className="flex  mx-auto justify-between mt-2 w-[350px] phone:w-[450px] tablet:w-[550px] laptop:w-[660px] p-1 phone:p-2  bg-gray-600 text-white border border-gray-700 phone:rounded-lg shadow-lg">
